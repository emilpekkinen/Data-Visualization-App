...
from PyQt6.QtWidgets import QApplication, QMainWindow, QGraphicsScene, QGraphicsView, QGraphicsTextItem, QPushButton, \
    QLabel, QInputDialog, QGraphicsEllipseItem
...
class PieChartView(QMainWindow):
    ...
    def draw_segment(self, data_point, pen, fill, i, x_value, font):
        ...
        segment_percentage = y_value / self.total
...
if __name__ == "__main__":
    ...
    csv_path = "F:/Programming/Y2/pythonProject/dataVisualizationLib/Documents/Company_Market_Cap.csv"
    lineplot = PieChartView(csv_path)
    lineplot.showMaximized()
    sys.exit(app.exec())
